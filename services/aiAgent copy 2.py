...
class AiAgent:
    ...
    def ask(self, prompt: str) -> dict:
        ...
        try:
            ...
            formatted = self.format_special_text(response.text)
    ...
    def find_tax_transactions(self, prompt: str) -> dict:
        '''
    ...
    def AgentPdf(self, source: str = None, prompt: str = None) -> dict:
        """
        ...
        try:
            ...
            formatted = self.format_special_text(res.text)
            return {"type": "text", "content": formatted}
    ...
    def find_transactions(self, prompt: str) -> dict:
        '''
        Tìm kiếm giao dịch trong Google Sheets dựa trên prompt.
        Sử dụng Google Gemini để trích xuất các trường dữ liệu có cấu trúc từ prompt.
